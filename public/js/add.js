...
let servantClass = ['saber','archer','lancer','rider','assassin','caster','shielder','avenger','alterego','ruler','berserker','mooncancer','foreigner']
...
//                 }
//                Ascension.create(req.body)
            
//             }
            
//             for(let i = 279; i < data.length-6; i++){
//                 const ascension1 = await cloudinary.uploader.upload(data[i].extraAssets.charaGraph.ascension[1]);
//                 const ascension2 = await cloudinary.uploader.upload(data[i].extraAssets.charaGraph.ascension[2]);
//                 const ascension3 = await cloudinary.uploader.upload(data[i].extraAssets.charaGraph.ascension[3]);
//                 const ascension4 = await cloudinary.uploader.upload(data[i].extraAssets.charaGraph.ascension[4]);
...
// for(let i = 0; i < 278; i++){
//     const skill1 = await cloudinary.uploader.upload(data[i].skills[0].icon);
// const skill2 = await cloudinary.uploader.upload(data[i].skills[1].icon);
// const skill3 = await cloudinary.uploader.upload(data[i].skills[2].icon);
...
//     funcPopupText : data[i].skills[1].functions[0].funcPopupText,
//     funcTargetTeam : data[i].skills[1].functions[0].funcTargetTeam,
//     funcTargetType : data[i].skills[1].functions[0].funcTargetType,
//     funcType : data[i].skills[1].functions[0].funcType,
...
//    funcPopupText : data[i].skills[2].functions[0].funcPopupText,
//    funcTargetTeam : data[i].skills[2].functions[0].funcTargetTeam,
//    funcTargetType : data[i].skills[2].functions[0].funcTargetType,
//    funcType : data[i].skills[2].functions[0].funcType,
//    svals : data[i].skills[2].functions[0].svals,
// }
// },
// appendPassive:{
// appendPassive0:{
...
//     for(let i = 0; i<data.length -5; i++){
    ...
    //     },
        // skills:{
        //     skills1:{
        //         name: data[0].skills[data[0].skills.length-3].name
        ...
        //      },
        //     skills2:{
        //         name: data[0].skills[data[0].skills.length-2].name
        ...
        //      },
        //     skills3:{
        //        name: data[0].skills[data[0].skills.length-1].name
